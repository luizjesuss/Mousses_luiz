    ...
    cart.forEach(item => {
        ...
        ">
            <div style= " margin: 0px">
             <p style= "font-weight: 500; margin: 0px">${item.name}</p>
             <p style= "font-weight: 500; margin: 0px">Qtd: ${item.quantity}</p>
             <p style= "font-weight: 500; margin-top: 0px">R$ ${item.price.toFixed(2)}</p>
            </div>
                 <button style= "font-weight: 500; margin: 0px" class = "remove-from-cart" data-name="${item.name}">
                 Remover
                 </button>
        </div>
        `
